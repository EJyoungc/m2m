<x-layout.root>
    ...
    <section class="py-12 bg-white">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold text-custom-gray mb-6">MediMothers: HIV, TB & Infant Care Management System
            </h2>
            <p class="text-lg text-gray-700 mb-6">An all-in-one system designed to streamline care for
                <strong>HIV-positive mothers and their infants</strong>, focusing on <strong>medication
                    adherence</strong>, <strong>TB screening</strong>, and <strong>infant health tracking</strong>. With
                powerful features and multi-platform support, this system enhances patient care and improves health
                outcomes.</p>
            ...
            <div class="bg-gray-100 rounded p-4 mb-6 shadow">
                <ul class="list-disc list-inside text-lg text-gray-700">
                    <li>
                        <strong>HIV Management:</strong>
                        <span class="text-gray-600">Medication scheduling, viral load & CD4 monitoring, appointment
                            reminders.</span>
                    </li>
                    <li>
                        <strong>TB Screening:</strong>
                        <span class="text-gray-600">Automated TB screening & test reminders for both mothers and
                            infants.</span>
                    </li>
                    <li>
                        <strong>Infant Care:</strong>
                        <span class="text-gray-600">Early HIV testing, vaccination schedules, growth & development
                            tracking.</span>
                    </li>
                    <li>
                        <strong>Multi-Platform Reminders:</strong>
                        <span class="text-gray-600">WhatsApp, Telegram, SMS, and more.</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="bg-gray-100 rounded p-4 mb-6 shadow">
                <ul class="list-disc list-inside text-lg text-gray-700">
                    <li><strong>Secure Database Management:</strong> Encrypted data storage to protect user information.
                    </li>
                    <li><strong>API Integrations:</strong> Seamless communication via <strong>WhatsApp, Telegram,
                            SMS</strong>.</li>
                    <li><strong>Scalable Server-Side Infrastructure:</strong> High availability to support growing user
                        needs.</li>
                </ul>
            </div>
            ...
            <div class="bg-gray-100 rounded p-4 mb-6 shadow">
                ...
                <ul class="list-disc list-inside text-lg text-gray-700">
                    <li><strong>Improving Medication Adherence:</strong> Ensuring mothers consistently take their
                        medications.</li>
                    <li><strong>Reducing HIV Transmission Risk:</strong> Providing timely information and support for
                        health maintenance.</li>
                    <li><strong>Enhancing Infant Care:</strong> Offering resources for monitoring and promoting infant
                        health.</li>
                    <li><strong>Streamlining Healthcare Efficiency:</strong> Facilitating better communication between
    ...
    <section class="relative bg-fixed bg-center bg-cover bg-no-repeat py-24"
        ...
        <div class="container mx-auto relative z-10 px-4 text-white text-center">
            ...
            <p class="text-xl mb-6">
                MediMothers is more than just an app – it's a lifeline for mothers. Whether you're expecting your first
                child or managing a growing family, MediMothers is here to support you every step of the way.
            </p>
            <p class="text-xl mb-6">
                Our app provides access to critical healthcare resources, personalized advice from experts, and a
                vibrant community of mothers to share your journey. With features tailored to your needs, we aim to
                empower you with the right tools to care for your health and the health of your family.
            </p>
            <p class="text-xl mb-6">
                From daily tips and reminders to direct access to healthcare professionals, MediMothers is designed to
                offer timely, trusted support when you need it the most. We believe in the power of community and the
                importance of accessible, reliable information for every mother.
            </p>
        </div>
    </section>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="p-6 bg-white rounded shadow">
                    ...
                    <p class="text-gray-700">Access a wealth of information on maternal and child health, including
                        articles, videos, and tools to help you manage your health effectively.</p>
                </div>
                <div class="p-6 bg-white rounded shadow">
                    <h3 class="text-xl font-semibold text-custom-teal mb-2">Community Support</h3>
                    <p class="text-gray-700">Connect with other mothers for support, advice, and shared experiences. Our
                        community forums provide a safe space to ask questions and share your journey.</p>
                </div>
                <div class="p-6 bg-white rounded shadow">
                    <h3 class="text-xl font-semibold text-custom-teal mb-2">Expert Advice</h3>
                    <p class="text-gray-700">Get access to healthcare professionals who can provide personalized advice
                        and answers to your health-related questions.</p>
                </div>
            </div>
        </div>
    </section>
