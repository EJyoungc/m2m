...
return [
    ...
    */
    ...
    'valid_numbers' => [12345, 67890],
    'menu_options' => [
        [['text' => 'Provide Art Number:'], ['text' => 'Client:']]
    ],
    'bot_token'=>'7808142186:AAExOBAngkxQnhfDIiP6s-vNh-VtP2mg_F4',

    'bots' => [
        'mybot' => [
            'token' => env('TELEGRAM_BOT_TOKEN', '7808142186:AAExOBAngkxQnhfDIiP6s-vNh-VtP2mg_F4'),
